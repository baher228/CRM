...
CLIENTS = [
    ...
    Client(
        ...
        website="https://evergreen-retail.example",
    ...
    Client(
        ...
        website="https://brightpath-studio.example",
...
LEADS = [
    Lead(
        ...
        website="https://orbit-analytics.example",
        status=LeadStatus.NEW,
        source="Website",
        confidence_score=82,
        outreach_angle="Reporting-heavy analytics pages mention implementation support.",
    ...
    Lead(
        ...
        website="https://blueharbour-foods.example",
        status=LeadStatus.CONTACTED,
        source="Referral",
        confidence_score=76,
        outreach_angle="Food distribution site highlights compliance and supplier onboarding.",
    ...
    Lead(
        ...
        source="Conference",
        confidence_score=91,
        outreach_angle="Public-sector procurement pages suggest an active buying window.",
