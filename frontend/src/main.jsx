...
import { fetchDiscoveryJob, fetchResource, startDiscoveryJob, generateBriefing, approveAction, getLatestBriefing } from "./api";
import "./styles.css";
      ...
      <section className="content">
        <header className="page-header">
          ...
          <StatusBadge tone={activeTab === "briefing" ? "purple" : activeTab === "discover" ? "blue" : "green"}>
            {activeTab === "briefing" ? "Live" : activeTab === "discover" ? "Live workflow" : "Dummy API"}
          </StatusBadge>
        </header>
